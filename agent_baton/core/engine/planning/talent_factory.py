...
class HeadlessTalentBuilderDispatcher:
    ...
    def _build_prompt(request: TalentBuilderRequest) -> str:
        ...
        return (
            ...
            "(opus|sonnet|haiku), permissionMode (MUST be 'default' -- a "
            "generated draft is never granted an elevated permission mode; "
            "a human promotes it after review), tools (least-privilege -- "
