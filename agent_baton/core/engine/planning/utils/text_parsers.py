...
_TASK_TYPE_KEYWORDS: list[tuple[str, list[str]]] = [
    ...
    ("bug-fix", ["fix", "bug", "broken", "error", "crash", "traceback", "exception",
                  "patch", "regression bug", "fails", "failing"]),
    ...
    ("audit", ["audit", "audit all", "code review", "security audit",
               "scorecard", "inspect all", "evaluate all",
               "code smells", "code quality", "review all"]),
    ("assessment", ["assess", "assessment", "evaluate", "gap analysis",
                     "fitness", "readiness", "maturity"]),
