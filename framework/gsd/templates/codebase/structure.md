...
- Usage: Reference from command with `@/home/djiv/PycharmProjects/orchestrator-v2/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/djiv/PycharmProjects/orchestrator-v2/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/djiv/PycharmProjects/orchestrator-v2/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
