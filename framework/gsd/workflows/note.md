...
- **Global scope**: `/home/djiv/PycharmProjects/orchestrator-v2/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/djiv/PycharmProjects/orchestrator-v2/.claude/notes/`)
...
2. Glob `/home/djiv/PycharmProjects/orchestrator-v2/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/djiv/PycharmProjects/orchestrator-v2/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/djiv/PycharmProjects/orchestrator-v2/.claude/notes/` — works in any directory
