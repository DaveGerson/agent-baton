# Orchestrator Skill v2 — Claude Code — Windows Install
...
Write-Host ""
Write-Host "  Orchestrator Skill v2 — Claude Code" -ForegroundColor Cyan
...
$SettingsJ = Join-Path $ScriptDir "settings.json"
