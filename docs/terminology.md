...
| **Assurance pack** | A governance bundle in `.claude/packs/<pack>/` with a `pack.json` manifest, policy/signals/rubric files, and optional gates/evidence. Distinct from knowledge packs: assurance packs enforce checks and risk controls. |
