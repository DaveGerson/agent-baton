...
export function SpecsPanel({ onBack }: SpecsPanelProps) {
  ...
  const loadSpecs = useCallback(async () => {
    ...
    try {
      ...
      // GET /api/v1/specs (agent_baton/api/routes/specs.py) returns a bare
      // Spec[] — not the {specs: [...]} SpecListResponse this panel was
      // written against. Coerce defensively: an undefined deref here
      // crashes the whole app at mount (no error boundary above).
